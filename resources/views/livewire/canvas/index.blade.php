        ...
        <div class="space-y-6">
            ...
            <x-ui-panel title="Canvases" subtitle="{{ $stats['total'] }} Canvas(es) in diesem Team">
                <x-ui-table compact="true">
                    ...
                    <x-ui-table-body>
                        ...
                        <x-ui-table-row compact="true" clickable="true" :href="route('bmc.canvases.show', $canvas)" wire:navigate>
            ...
            <x-ui-panel>
                <div class="p-12 text-center">
                    ...
                    <p class="text-[var(--ui-muted)]">Erstelle dein erstes Business Model Canvas per Chat.</p>
                </div>
            </x-ui-panel>
            @endif
        </div>
