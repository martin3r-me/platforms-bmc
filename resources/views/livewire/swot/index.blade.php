<x-ui-page>
    ...
    <x-ui-page-container>
        <div class="space-y-6">
            ...
            <x-ui-panel title="SWOT-Analysen" subtitle="{{ $stats['total'] }} Analyse(n) in diesem Team">
                <x-ui-table compact="true">
                    ...
                    <x-ui-table-body>
                        ...
                        <x-ui-table-row compact="true" clickable="true" :href="route('bmc.swot.show', $canvas)" wire:navigate>
                            ...
                            <x-ui-table-cell compact="true">
                                <span class="text-sm">{{ $canvas->building_blocks_count }}/4</span>
                            </x-ui-table-cell>
                            <x-ui-table-cell compact="true">
            ...
            <x-ui-panel>
                <div class="p-12 text-center">
                    @svg('heroicon-o-arrow-path-rounded-square', 'w-16 h-16 text-[var(--ui-muted)] mx-auto mb-4')
                    <h3 class="text-lg font-semibold text-[var(--ui-secondary)] mb-2">Noch keine SWOT-Analysen</h3>
                    <p class="text-[var(--ui-muted)]">Erstelle deine erste SWOT-Analyse per Chat.</p>
                </div>
            </x-ui-panel>
            @endif
        </div>
                    ...
                    <div class="space-y-1">
                        <button wire:click="setStatusFilter('')"
                            ...
                            <span class="d-flex items-center gap-2">
                                @svg('heroicon-o-arrow-path-rounded-square', 'w-3.5 h-3.5')
                                Alle
                            </span>
