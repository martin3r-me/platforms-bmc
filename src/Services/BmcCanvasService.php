...
class BmcCanvasService
{
    /**
     * Create a new canvas with all 9 Osterwalder building blocks.
     */
    public function createCanvas(array $data): BmcCanvas
    {
        $canvas = BmcCanvas::create($data);
     ...
     */
    public function createSnapshot(BmcCanvas $canvas, int $userId): \Platform\Bmc\Models\BmcCanvasSnapshot
    {
    ...
    public function compareSnapshots(
        \Platform\Bmc\Models\BmcCanvasSnapshot $snapshotA,
        \Platform\Bmc\Models\BmcCanvasSnapshot $snapshotB
    ): array {
    ...
    /**
     * Export canvas as structured data for Markdown/PDF generation.
     */
