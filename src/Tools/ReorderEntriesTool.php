...
class ReorderEntriesTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'bmc.entries.reorder.PUT';
    }

    public function getDescription(): string
    {
        return 'PUT /bmc/entries/reorder - Sortiert Entries innerhalb eines Building Blocks neu. ERFORDERLICH: building_block_id, entry_ids (geordnetes Array von Entry-IDs).';
    }
